...
const ComingSoonBadge = styled.div`
  background: linear-gradient(45deg, #00d4aa, #0096a8);
  color: white;
  padding: 12px 24px;
  border-radius: 25px;
  font-weight: 600;
...
const TNTTraining = () => {
  ...
  const renderBeyondChartsContent = () => (
    <TabContent $active={activeTab === 'beyond-charts'}>
      {loading && <LoadingMessage>{t('tntTraining.loadingSessions')}</LoadingMessage>}
  ...
  const renderTNTContent = () => (
    <TabContent $active={activeTab === 'tnt'}>
      <OnboardingContent>
        <OnboardingTitle>{t('tntTraining.welcomeTitle')}</OnboardingTitle>
        <OnboardingDescription>
          {t('tntTraining.welcomeDescription')}
        </OnboardingDescription>
        <ComingSoonBadge>{t('tntTraining.comingSoon')}</ComingSoonBadge>
      </OnboardingContent>
    </TabContent>
  );

  const renderOnboardingContent = () => (
    <TabContent $active={activeTab === 'onboarding'}>
      <OnboardingContent>
        <OnboardingTitle>{t('tntTraining.onboardingTitle')}</OnboardingTitle>
        <OnboardingDescription>
          {t('tntTraining.onboardingDescription')}
        </OnboardingDescription>
        <ComingSoonBadge>{t('tntTraining.comingSoon')}</ComingSoonBadge>
      </OnboardingContent>
    </TabContent>
